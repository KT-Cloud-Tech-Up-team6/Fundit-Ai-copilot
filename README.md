...
MCP를 단순 상품 조회 Wrapper로만 사용하지 않고, 판매자가 제공한 답변을 동적으로 갱신되는 Knowledge로 활용합니다.
...
MCP Live Knowledge
        ↓
구매자용 Post-Live Q&A
판매자는 live_id나 질문을 직접 입력하지 않고, 시스템이 선정한 질문에 대한 답변만 입력합니다.
...
A2A는 현재 구현 예정 단계입니다.
           ...
           Product Agent    Platform Agent
                  ...
                  MCP        Platform Data
                   │
          Product Knowledge
MCP는 Agent와 Knowledge / Tool의 연결, A2A는 Agent와 Agent 간 역할 분담 및 협업을 담당하도록 설계할 예정입니다.
